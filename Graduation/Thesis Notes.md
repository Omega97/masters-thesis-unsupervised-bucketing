...
* **Original Research:** Students must develop a thesis containing original results, guided by a supervisor.
* **Problem-Solving:** The thesis typically addresses a problem proposed by a research lab or company, requiring students to analyze the problem and apply effective tools.
* **Supervision:**
    * Supervisors are usually faculty members.
    * External supervisors require program coordinator authorization.
    * Co-supervisors (internal or external) must be communicated to the coordinator.
    * If the research is done in an external institution, an internal supervisor is mandatory.
* **Language:** The thesis must be written and discussed in English.
    
**2. Pre-Laurea (First Discussion):**
* **Technical Presentation:** A 40-45 minute presentation with slides, followed by questions.
* **Committee:** Supervisor and two other faculty/partner institution members (at least one faculty member).
* **Committee Report:** A report with a judgment and a proposed final mark increment (0-10) and if the committee is favorable to assign the "laude". This report is sent to the coordinator or president of the graduation committee.
* **Thesis Submission:** A PDF of the thesis must be sent to the pre-laurea committee, coordinator, and president of the graduation committee at least one day before the defense.
    
**3. Laurea (Final Discussion):**
* **Short Presentation:** A 10-12 minute presentation with slides.
* **Committee:** Officially appointed by the department head.
* **Final Mark:** The committee privately discusses and assigns the final mark.
* **Graduation:** Official declaration of graduation.
* **Thesis Submission:** The thesis must be officially uploaded to the university repository.
    
**4. Final Mark Calculation:**
* **Weighted Average:** Based on exam marks and corresponding credits.
* **Thesis Evaluation:** A mark (typically 0-10, potentially higher for exceptional theses) added by the committee.
* **Final Score:** Out of 110.
* **"Laude":** Awarded at the committee's discretion, considering career, achievements, and thesis work.
    

**Key Points:**
* Adhere to university bureaucratic procedures and deadlines.
* Clear and understandable presentation of results is crucial.
* Communication with the program coordinator is essential for external supervisors and co-supervisors.
* The pre-laurea is a technical deep dive, and the laurea is a short summary.
* The final mark considers the whole student career.
...
The bureaucratic procedure to apply for the final examination (deadlines and tasks to accomplish) is available from the university website, at this page (?). Please read the instructions and follow the carefully. 
