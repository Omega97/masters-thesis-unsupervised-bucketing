...
There is no principled, unsupervised method for discovering a meaningful partition of the state space that \emph{maximises expert specialisation}, particularly when the model is already trained and the routing must be both fast and interpretable.
% Contribution
